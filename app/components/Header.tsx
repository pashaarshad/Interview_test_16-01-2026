      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between py-4">
          <div className="flex items-center gap-2">
            <SkyscannerLogo />
            <span className="text-xl font-semibold tracking-tight">Skyscanner</span>
          </div>
          
          <div className="flex items-center gap-6">
            <button className="text-sm hover:text-sky-300 transition-colors flex items-center gap-1">
              Help
            </button>
