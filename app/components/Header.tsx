...
const SkyscannerLogo = () => (
    <svg viewBox="0 0 201 128" className="w-8 h-8" fill="white">
...
export default function Header({ activeTab, onTabChange }: HeaderProps) {
    const tabs = [
        { id: 'flights' as const, label: 'Flights', icon: FlightIcon },
        { id: 'hotels' as const, label: 'Hotels', icon: HotelIcon },
        { id: 'tours' as const, label: 'Tours', icon: ToursIcon },
    ];
            ...
            <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
                ...
                <div className="flex items-center justify-between h-14">
                    ...
                    <div className="flex items-center gap-2">
                        <button className="text-sm hover:underline px-2 py-1">
                            Help
                        </button>
                        <button className="hidden sm:flex items-center gap-2 bg-[#1a3a5c] hover:bg-[#254a6f] px-3 py-1.5 rounded text-sm transition-colors">
                        ...
                        <button className="bg-[#1a3a5c] hover:bg-[#254a6f] px-4 py-1.5 rounded text-sm font-medium transition-colors">
                            Log in
                        </button>
                    </div>
                </div>
